...
public class AddressBookMain extends com.addressbook.ContactPerson {
    public static AddressBookMain newPerson = new AddressBookMain();
    public static ArrayList<com.addressbook.ContactPerson> person = new ArrayList<>();
    ...
    public static void add() throws Exception{
        ...
        Optional<com.addressbook.ContactPerson> isEmpty=person.stream()
        ...
        com.addressbook.ContactPerson contactPerson = new com.addressbook.ContactPerson(newPerson.getFirstName(),newPerson.getLastName(), newPerson.getAddress(), newPerson.getCity(), newPerson.getState(), newPerson.getZip(), newPerson.getPhoneNumber(),newPerson.getEmail());
        System.out.println("Enter type");
        newPerson.setType(scanner.nextLine());
        com.addressbook.ContactPerson contactPerson = new com.addressbook.ContactPerson(newPerson.getFirstName(),newPerson.getLastName(), newPerson.getAddress(), newPerson.getCity(), newPerson.getState(), newPerson.getZip(), newPerson.getPhoneNumber(),newPerson.getEmail(), newPerson.getType());
...
//        System.out.println(person);
    ...
    public static void modify(){
        ...
        boolean found=false;
        ListIterator<com.addressbook.ContactPerson> iterator = person.listIterator();
        while (iterator.hasNext()){
            com.addressbook.ContactPerson contact= iterator.next();
            if (name.equals(contact.getFirstName()))
            {
                ...
                newPerson.setEmail(scanner.nextLine());
                iterator.set(new com.addressbook.ContactPerson(newPerson.getFirstName(),newPerson.getLastName(), newPerson.getAddress(), newPerson.getCity(), newPerson.getState(), newPerson.getZip(), newPerson.getPhoneNumber(),newPerson.getEmail()));
                System.out.println("Edit type");
                newPerson.setType(scanner.nextLine());
                iterator.set(new com.addressbook.ContactPerson(newPerson.getFirstName(),newPerson.getLastName(), newPerson.getAddress(), newPerson.getCity(), newPerson.getState(), newPerson.getZip(), newPerson.getPhoneNumber(),newPerson.getEmail(),newPerson.getType()));
                found=true;
            }
    ...
    public static void sortByName(){
        ...
        person.stream()
                .sorted(Comparator.comparing(com.addressbook.ContactPerson::getFirstName))
    ...
    public static void sortByCity() {
        System.out.println("Sorted list is\n");
        person.stream()
                .sorted(Comparator.comparing(com.addressbook.ContactPerson::getCity))
                .forEach(System.out::println);
    }
    ...
    public static void sortByState() {
        System.out.println("Sorted list is\n");
        person.stream()
                .sorted(Comparator.comparing(com.addressbook.ContactPerson::getState))
                .forEach(System.out::println);
    }
    public static void readFromfile() throws Exception {
        if (file2.isFile()) {
            try {
                ...
                person = (ArrayList<com.addressbook.ContactPerson>) objectStreamReader.readObject();
            }catch (Exception e){}
        }
        if (fileJson.isFile()) {
            try {
                jsonReader = new FileReader(fileJson);
                com.addressbook.ContactPerson contactPerson = new com.addressbook.ContactPerson();
                Gson gsonObj = new Gson();
